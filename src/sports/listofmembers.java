...
public class listofmembers extends javax.swing.JFrame {
    ...
    public listofmembers() {
        ...
        try{
            ...
            String colhead[]={"ID", "NAME","FATHER'S NAME","ADDRESS","CONTACT","EMAIL","DOB","GENDER","GAMETYPE","GAME","BATCH","COACH","COURT","PACKAGES","FEE"};
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "NAME", "FATHER'S NAME", "ADDRESS", "CONTACT", "EMAIL", "DOB", "GENDER", "GAMETYPE", "GAME", "BATCH", "COACH", "COURT", "PACKAGES", "FEE"
            }
        ));
